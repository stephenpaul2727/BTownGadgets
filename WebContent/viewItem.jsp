...
<table class="table table-hover table-sm style="align:center">


<tr style="background-color: #eff2f7"><td><img src="<%=product.getImagePath() %>" class="img-responsive" height ="100dp" width="250dp"/></td>
<td><u>Details</u><br><%=product.getBrand() %><br><%=product.getModel_name() %><br>
Price: <i><%=product.getPrice() %>$</i><br>Available: <%=product.getQuantity() %><br><br><br></td>
<td>
...
<form action="ServletController" method="get" id="cart">
	...
	<button class="btn btn-primary" value="Add To Cart" type ="submit">Add To Cart</button>
</form>
<%} %>
</td>
</tr>
