...
<% List<OrderDetails> orderItems = (List<OrderDetails>)session.getAttribute("PendingReturns"); %>
<%int i=0;int size=orderItems.size(); %>
<%if(size==0){ %>
<center><h3>No Returns Pending</h3></center>
<%} %>
...
<%} %>
	...
	<input type="hidden" name="action" value="ItemsReturned">
	<input type="submit" value="Items Returned" >
